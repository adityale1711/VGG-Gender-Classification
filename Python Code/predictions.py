...
for (x, y, w, h) in faces:
    ...
    pred_image = cv2.resize(face_image, (178, 218))
    ...
    cv2.putText(image, f'Prediction: {prediction_label}', (x, y - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                (0, 0, 255), 2)
    cv2.putText(image, f'Accuracy: {prediction_accuracy * 100:.2f}%', (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                (0, 0, 255), 2)
